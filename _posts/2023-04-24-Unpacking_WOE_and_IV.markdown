...
When we apply the Woe_IV_Dis function to the "Sex" variable in the [Titanic - Machine Learning from Disaster](https://www.kaggle.com/competitions/titanic/data) competition data, we get some interesting insights.
...
Now, let's take a look at the table generated by the Woe_IV_cont function for the "Fare" variable.
