...
<img src="https://latex.codecogs.com/png.image?\dpi{110}Kernel&space;Quadr&space;tico(\textbf{W},\textbf{Q})&space;=&space;(\textbf{W}^T&space;\textbf{Q})^2&space;&space;&space;" title="Kernel Quadr tico(\textbf{W},\textbf{Q}) = (\textbf{W}^T \textbf{Q})^2 " />

<img src="https://latex.codecogs.com/png.image?\dpi{110}Kernel&space;Quadr&space;tico(\textbf{W},\textbf{Q})&space;=&space;(x_1&space;x_2&plus;y_1&space;y_2&space;)^2&space;&space;" title="Kernel Quadr tico(\textbf{W},\textbf{Q}) = (x_1 x_2+y_1 y_2 )^2 " />

<img src="https://latex.codecogs.com/png.image?\dpi{110}Kernel&space;Quadr&space;tico(\textbf{W},\textbf{Q})&space;=&space;x_1^2&space;x_2^2&plus;2x_1&space;x_2&space;y_1&space;y_2&plus;y_1^2&space;y_2^2" title="Kernel Quadr tico(\textbf{W},\textbf{Q}) = x_1^2 x_2^2+2x_1 x_2 y_1 y_2+y_1^2 y_2^2" />

<img src="https://latex.codecogs.com/png.image?\dpi{110}Kernel&space;Quadr&space;tico(\textbf{W},\textbf{Q})&space;=&space;(x_1^2&plus;&space;\sqrt{2x_1&space;y_1}&plus;y_1^2)^T&space;&space;(x_2^2&plus;\sqrt{2x_2&space;y_2}&space;&plus;y_2^2)" title="Kernel Quadr tico(\textbf{W},\textbf{Q}) = (x_1^2+ \sqrt{2x_1 y_1}+y_1^2)^T (x_2^2+\sqrt{2x_2 y_2} +y_2^2)" />

<img src="https://latex.codecogs.com/png.image?\dpi{110}Kernel&space;Quadr&space;tico(\textbf{W},\textbf{Q})&space;=&space;&space;(\textbf{W})^T&space;&space;(\textbf{Q})&space;" title="Kernel Quadr tico(\textbf{W},\textbf{Q}) = (\textbf{W})^T (\textbf{Q}) " />

O mapeamento dos pontos para uma dimensão de espaço mais alta, é dada pela função:
<img src="https://latex.codecogs.com/svg.image?&space;ϕ(Ponto)={x^2,&space;\sqrt{2xy},y^2}&space;" title=" ϕ(Ponto)={x^2, \sqrt{2xy},y^2} " />
