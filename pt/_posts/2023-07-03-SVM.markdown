...
img: ":SVM.jpg"
img_alt: "Ilustração sobre Máquinas de Vetores de Suporte (SVM)"
...
![Exemplo da dimensão Vapnik-Chervonenkis mostrando separação linear de pontos](:SVM/DimensaoVC.png)

No entanto, ao utilizar 4 pontos, já existem algumas combinações que não podem ser separadas por uma única função linear.


![Exemplo de classificação binária com quatro pontos não linearmente separáveis](:SVM/Exemplo4.png)
...
![Representação de hiperplano como reta em 2D e plano em 3D](:SVM/Hiperplanodim2e3.png)
...
![Exemplo de múltiplos hiperplanos separando classes em um problema SVM](:SVM/Hiperplanos.png)
...
![Hiperplano ótimo com margem máxima entre as classes no SVM](:SVM/Hiperplanocommaiormargem.png)
...
![Vetores de suporte próximos à fronteira de decisão do SVM](:SVM/Vetoresdesuporte.png)
...
![Comparação entre margens suaves e margens rígidas em SVM](:SVM/Margenssuaves.png)
...
![Exemplo de dados não linearmente separáveis ilustrando o Teorema de Cover](:SVM/TeoremadeCover.png)
...
![Transformação de dados para um espaço de características de maior dimensão](:SVM/Espacodecaracterísticas.png)
...
![Exemplo de classificação multiclasse utilizando SVM](:SVM/SVMMulticlasse.png)
